...
namespace EnterprisePMO_PWA.Application.Services
{
    ...
    public class EnhancedNotificationService : INotificationService
    {
        ...
        /// <summary>
        /// Enqueues an email notification to be sent asynchronously by Hangfire.
        /// </summary>
        public void EnqueueEmailNotification(string recipientEmail, string subject, string body)
        {
            // Fix for the expression tree error - use overload without optional parameters
            BackgroundJob.Enqueue(() => SendEmailWithoutOptionals(recipientEmail, subject, body));
        }
